...
public class CloudshellCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(CloudshellCliTestCommand.class);
    protected final CloudshellCliCommands service;

    public CloudshellCliTestCommand(final CloudshellCliCommands service) {
